...
if __name__ == '__main__':
    print
    'Authentification du visiteur a131 :'
    print
    seConnecter('a131', '')
    print

    print
    'Liste des rapports de visite du visiteur a131 :'
    ...
    print
    'Générer numero rapport pour le visiteur a131 :'
    print
    genererNumeroRapportVisite('a131')
    print
    '''
    ...
    print
    'Liste des medicaments offerts par le visiteur a131 lors de sa 1ère visite :'
